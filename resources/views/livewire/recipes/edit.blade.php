<div class="mb-4" x-data x-on:recipe-updated="$refs.editmodal.hidePopover()">
    <a x-on:click.prevent="$refs.editmodal.showPopover()" href="#"
        class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-2 rounded shadow-md">
        Modifier
    </a>
